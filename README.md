...
1. Run `npm install` on the client folder to install all project dependencies.
...
The code associated with this is in [NewSound.js](https://github.com/kubozi/SONIVERSE/blob/main/client/src/components/Sounds/NewSound.js) fileSubmitHandler method. \ 
...
NFT asset the ownership on the smart contract will change to the buyer's address. The buy/collect functionality on the client side is located in [SoundDetails.js](https://github.com/kubozi/SONIVERSE/blob/main/client/src/components/Sounds/SoundDetails.js)

React components: The main component responsible for rendering the platform is [App.js](https://github.com/kubozi/SONIVERSE/blob/main/client/src/App.js). \
App.js consists of a header with the [navbar](https://github.com/kubozi/SONIVERSE/blob/main/client/src/components/Navbar/Navbar.js), the main body with the \ sound related components [sound components](https://github.com/kubozi/SONIVERSE/tree/main/client/src/components) and a placeholder [footer](https://github.com/kubozi/SONIVERSE/tree/main/client/src/components/Footer)

Smart contract interaction: The code responsible for interacting with the deployed smart contracts on the Tezos network is located at [tezosUtils](https://github.com/kubozi/SONIVERSE/blob/main/client/src/blockchain/tezos/tezosUtils.js)

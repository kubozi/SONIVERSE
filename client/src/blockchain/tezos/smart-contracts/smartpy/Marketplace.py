# deploy on smartpy io website 
# first token (set storage to deployer address)
# then marketplace (set token address at the botton on storage)
# then set_administrator on token to the marketplace address
